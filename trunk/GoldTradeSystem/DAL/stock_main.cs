...
namespace GoldTradeNaming.DAL
{
    ...
    public class stock_main
    {
        ...
        public DataSet getAllInfoAboutM(string Fran_ID)
        {
            ...
            strSql.Append(",stock_total,count_total=(stock_total/product_spec_id), stock_left,count_left=(stock_left/product_spec_id), ins_user, ins_date, upd_user,upd_date  ");
        ...
        public DataSet getSalesReport()
        {
            ...
            try
            {
                ...
                strSql.Append("stock_total=isnull((sum(stock_main.stock_total)),''),");
                strSql.Append("stock_left=isnull((sum(stock_main.stock_left)),''),");
                strSql.Append("trade_money=isnull((sum(franchiser_trade_desc.trade_money)),0),");
                strSql.Append("trade_weight=isnull((sum(franchiser_trade_desc.trade_weight)),0)");
                ...
                strSql.Append(" and product_type.product_spec_weight=franchiser_order_desc.product_spec_id)");
                strSql.Append(" left join stock_main  on(product_type.product_type_id=stock_main.product_id ");
                strSql.Append(" and product_type.product_spec_weight=stock_main.product_spec_id)");
                strSql.Append(" left join franchiser_trade_desc  on(product_type.product_type_id=franchiser_trade_desc.product_id");
                strSql.Append(" and product_type.product_spec_weight=franchiser_trade_desc.product_spec_id)");
                ...
                //ds.Relations.Add("ProductId", ds.Tables[0].Columns["product_type_id"], ds.Tables[1].Columns["product_type_id"]);
        ...
        public bool stock_chang(string fran_id, int product_type_id, int product_kind_id, int tag, int mount)
        {
            ...
            try
            {
                ...
                int stock_total = Convert.ToInt32(ds.Tables[0].Rows[0]["stock_total"]);
                int stock_left = Convert.ToInt32(ds.Tables[0].Rows[0]["stock_left"]);
                ...
                SqlParameter[] parameters2 = {
					...
					new SqlParameter("@product_id", SqlDbType.Int,4),
					new SqlParameter("@product_spec_id", SqlDbType.Int,4),
                    new SqlParameter("@stock_total", SqlDbType.Int,4),
					new SqlParameter("@stock_left", SqlDbType.Int,4)  
                                            };
            ...
            strSql.Append(" where id=@id ");
                ...
                SqlParameter[] parameters = {
                    ...
                    SqlParameter[] parameter2 ={
                                                    ...
                                                    new SqlParameter("@product_id", SqlDbType.Int,4),
                                                    new SqlParameter("@product_spec_id", SqlDbType.Int,4),
                                                    new SqlParameter("@stock_total_changed", SqlDbType.Int,4),
                                                    new SqlParameter("@stock_left_changed", SqlDbType.Int,4),
                                                    new SqlParameter("@ins_user", SqlDbType.NVarChar,50)
