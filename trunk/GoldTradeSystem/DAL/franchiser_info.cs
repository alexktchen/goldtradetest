...
namespace GoldTradeNaming.DAL
{
    ...
    public class franchiser_info
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 50 franchiser_code,franchiser_name,franchiser_balance_money,franchiser_asure_money,franchiser_tel,franchiser_cellphone,franchiser_address,ins_user,ins_date,upd_user,upd_date,IA100GUID ");
