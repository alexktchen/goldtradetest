	...
	public class send_main
	{
        ...
        public DataSet GetOrderedProductList(string strWhere)
        {
            ...
            strSql.Append(@"select id,franchiser_order_id,product_id,
                            ...
                            order_weight,
                            product_received,
                            received_num=product_received/product_spec_id,
                            product_unreceived,
                            unreceived_num=product_unreceived/product_spec_id,
                    ...
                    try
                    {
                        ...
                        foreach (GoldTradeNaming.Model.send_desc sd in sdlst)
                        {
                            ...
                            SqlParameter[] parameters3 = {					               
				                new SqlParameter("@this_receive", SqlDbType.Int,4),
				                new SqlParameter("@franchiser_order_id", SqlDbType.Int,4),
				                new SqlParameter("@product_id", SqlDbType.Int,4),
				                new SqlParameter("@product_spec_id", SqlDbType.Int,4)
				               };
                    ...
                    try
                    {
                        ...
                        {                           
                            ...
                            SqlParameter[] parameters4 = {					               
				                ...
				                new SqlParameter("@this_send", SqlDbType.Int,4),
                                new SqlParameter("@insuser",SqlDbType.NVarChar,50)
				               };
                            parameters4[0].Value = Convert.ToInt32(dr[1]);
                            parameters4[1].Value = Convert.ToInt32(dr[2]);
                            parameters4[2].Value = franId;
                            parameters4[3].Value = Convert.ToInt32(dr[3].ToString());
