<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GoldTradeNaming.Web.franchiser_money.Manage" Title="审核入帐" %>
            ...
            <td style="width: 83%">
                ...
                <asp:GridView ID="showDate" runat="server" Width="100%" AllowPaging="True" 
                    ...
                    <Columns>
                      ...
                      <%--  <asp:TemplateField>
                        <ItemTemplate>
                        <asp:LinkButton ID="del" CommandName="CmdDEL" Text="删除" runat="server" ></asp:LinkButton>
                        </ItemTemplate>
                        </asp:TemplateField>--%>
                        
                        <asp:CommandField DeleteText="&lt;div id=&quot;de&quot; onclick=&quot;JavaScript:return confirm('确定删除吗？')&quot;&gt;删除&lt;/div&gt; " 
                            ShowDeleteButton="True" />
                        <asp:CommandField EditText="&lt;div id=&quot;de&quot; onclick=&quot;JavaScript:return confirm('确定审核吗？')&quot;&gt;审核&lt;/div&gt; " 
                            ShowEditButton="True" />
                    </Columns>
