    ...
    public partial class ShowM:System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender,EventArgs e)
        {
            if(!Page.IsPostBack)
            {
                ...
                // btnCancle.Attributes.Add("onclick","return confirm('" + "取消该交易将会还原交易信息(库存与余额)，确定要取消嘛?" + "')");

            }
        }


        //private bool GetTradeList()
        //{
        //    DataSet ds = bll.GetAllTrade(Session["TradeM"].ToString().Trim());
        ...
        //    string fran_id = gvTrade.SelectedRow.Cells[1].Text.Trim();

        //    int iCount = bll.ConfirmCancle(tradeid,fran_id);//
        //    if(iCount > 0)
        //    {
        //        DataSet ds = SearchTradeInfo();
        //        Session["gvTrade"] = ds;
        ...
        //        lblQueryMsg.Text = "取消成功！";
        //    }
        //    else
        //    {
        //        MessageBox.Show(this,"取消异常");
        //        lblQueryMsg.Text = "取消异常";
        //    }
        //}
