...
namespace GoldTradeNaming.Web.stock_main
{
	...
	private void ShowInformation(int id)
	{
        try
        {
            ...
            this.txtstock_total.Text = model.stock_total.ToString();
            this.txtFranchiser_name.Text = model.franchiser_name.ToString();
            this.txtstock_left.Text = model.stock_left.ToString();
	...
	int stock_left=int.Parse(this.txtstock_left.Text);
    int temp = stock_left - int.Parse(ViewState["stock_left_temp"].ToString());
    int stock_total = int.Parse(this.txtstock_total.Text);
    stock_total = stock_total + temp;
