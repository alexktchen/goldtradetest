...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <anthem:GridView ID="GridView2" runat="server" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="order_weight" HeaderText="订购重量" />
            <asp:BoundField DataField="product_received" HeaderText="已收重量" />
            <asp:BoundField DataField="product_unreceived" HeaderText="未收重量" />
