    ...
    public partial class Franchiser : System.Web.UI.MasterPage
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                decimal balanceMoney = frninfo.franchiser_balance_money;
                decimal asureMoney = frninfo.franchiser_asure_money;
                ...
                unReceiveValue = bll.GetGoldNoReceiveValue(franid.ToString()); //黄金价值  
                unReceiveValue += bll.GetSilverNoReceiveValue(franid.ToString());//白银价值              

                stockValue = bll.GetGoldStockValue(franid.ToString());
                stockValue += bll.GetSilverStockValue(franid.ToString());

                decimal money_use;
                money_use = balanceMoney - asureMoney - stockValue - unReceiveValue;

                lblTradeBalance.Text = money_use.ToString();
            }
            catch
            {
