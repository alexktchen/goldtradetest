...
namespace GoldTradeNaming.Web.send_desc
{
    ...
    {       
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (GridViewRow gvr in this.GridView1.Rows)
                {
                    ...
                    sdone.product_spec_id = Convert.ToInt32(gvr.Cells[1].Text);
        ...
        protected void ProdNumChg(object sender, EventArgs e)
        {
            ...
            try
            {
                int spec_weight = Convert.ToInt32(GridView1.Rows[drv.RowIndex].Cells[1].Text.ToString());
                int unreceived_weight = Convert.ToInt32(GridView1.Rows[drv.RowIndex].Cells[4].Text.ToString());
