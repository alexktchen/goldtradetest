...
namespace GoldTradeNaming.Web.sys_admin_authority
{
    public partial class Show:System.Web.UI.Page
    {
        private static string[] ckbControls = { "AddAdmin","AddFran","AddIA","AddMoney","AddProduct","AuthMgn","CheckAddMoney","ChgFran","TradeLock",
                                       ...
                                       "ViewFran","ViewOrder","ViewPrice","ViewProduct","ViewTrade" ,"ViewStockLog"};
        ...
        protected void btnSave_Click(object sender,EventArgs e)
        {
            try
            {
                ...
                ArrayList alModule = new ArrayList(24);
                ...
                MessageBox.ShowAndRedirect(this,"保存成功...","../sys_admin_authority/Show.aspx");
