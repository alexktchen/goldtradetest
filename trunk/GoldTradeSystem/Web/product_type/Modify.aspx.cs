...
namespace GoldTradeNaming.Web.product_type
{
    public partial class Modify : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (row.Cells[6].Text.Trim().Equals("黄金"))
            { this.type = "0"; }
            else { this.type = "1"; }
            if (!Page.IsPostBack)
            {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.drptype.Text.Trim().Equals("白银"))
            {
            ...
            //string ins_date = this.txtins_date.Text;
            //string upd_user = Session["admin"].ToString();
            //string upd_date = DateTime.Now.ToString();
            ...
            model.product_spec_weight = Convert.ToInt32(product_spec_weight);
            ...
            //model.ins_date = DateTime.Parse(ins_date);
