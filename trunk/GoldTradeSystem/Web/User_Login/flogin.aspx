...
sub ShowErr(Msg)
	...
	Document.Writeln "<P ALIGN='CENTER'><a href='flogin.aspx'  class='blue01'>返回</a> "
...
<body text="#000000"  bgcolor="#FFFFFF">
    ...
    <form id="CheckForm" method="post" action="fverify.aspx" onsubmit="CheckData()">
    ...
    <div id="dengl1">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="520">
            <tr>
                <td width="79" height="116">
                    <img name="dengl_1_r1_c1_r1_c1" src="../image/dengl_1_r1_c1_r1_c1.gif" border="0"
                        id="dengl_1_r1_c1_r1_c1" alt="" />
                </td>
                <td>
                    <img name="dengl_1_r1_c1_r1_c2" src="../image/dengl_1_r1_c1_r1_c2.gif" width="347"
                        height="116" border="0" id="dengl_1_r1_c1_r1_c2" alt="" />
                </td>
                <td width="94" height="116">
                </td>
            </tr>
            <tr>
                <td>
                    <img name="dengl_1_r1_c1_r2_c1" src="../image/dengl_1_r1_c1_r2_c1.gif" width="79"
                        height="326" border="0" id="dengl_1_r1_c1_r2_c1" alt="" />
                </td>
                <td>
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="347">
                        <tr>
                            <td>
                                <img name="dengl_1_r1_c1_r2_c2" src="../image/dengl_1_r1_c1_r2_c2.gif" width="347"
                                    height="54" border="0" id="dengl_1_r1_c1_r2_c2" alt="" />
                            </td>
                        </tr>
                        <tr>
                            <td width="347" height="272" background="../image/dengl_1_r1_c1_r3_c2.gif">
                                <table width="300" border="0" align="center">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <input name="edtiaid" type="text" class="cttextboxt" id="edtiaid" maxlength="16" size="20">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                           <input name="edtiaupin" type="password" class="cttextboxt" id="edtiaupin" value="" maxlength="16" size="20">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <span class="ctbody3"><span class="blue01"><a href="Init.htm">安装IA100插件</a></span></span>
                                        </td>
                                        <td align="center">
                                            <span class="ctbody3"><span class="blue01"><a href="lib/setup.exe">下载插件安装</a></span></span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <td>
                    <img name="dengl_1_r1_c1_r2_c3" src="../image/dengl_1_r1_c1_r2_c3.gif" width="94"
                        height="326" border="0" id="dengl_1_r1_c1_r2_c3" alt="" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="foot">
        技术支持：13625778033 Copyright &copy;2009-2010 金牛企业</div>
</body>
</html>
