...
<%
    ...
    using (SqlConnection connection = new SqlConnection(Conn))
    {
        ...
        ssql.Append("SELECT B.franchiser_code, A.IA100Key  FROM goldtrade_IA100 A   JOIN franchiser_info B ");
        ...
        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        {
            ...
            {
                Response.Write("<script language=\"javascript\">alert('登录时发生错误！'); window.location.href='flogin.aspx';</script>");
                return;
            }
        }
    ...
    if (CDigest != SDigest)
    {
        Response.Write("<script language=\"javascript\">alert('" + "登录出错，请重新操作或联系管理员!" + "'); window.location.href='flogin.aspx';</script>");
        return;
    }
    else
    {
        Session["fran"] = sAdminId;
        Response.Redirect("AgreeProtol.aspx");
    }
