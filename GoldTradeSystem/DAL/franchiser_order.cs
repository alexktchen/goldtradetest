...
{
    /*
     0512 田杰更改SaveOrderInfo方法：更改订单号生成方式
     */
            ...
            using (SqlConnection conn = new SqlConnection(PubConstant.ConnectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    try
                    {
                        ///edit by tianjie 
                        ///
                        //string strnextid = "1"+(DateTime.Now.Year-2000)
                        ...
                        foreach (GoldTradeNaming.Model.franchiser_order_desc sd in orderlst)
                        {
                            ...
                            SqlParameter[] parameters2 = {
					                ...
					                new SqlParameter("@product_received", SqlDbType.Decimal,4),
					                new SqlParameter("@product_unreceived", SqlDbType.Decimal,4),
					                new SqlParameter("@ins_user", SqlDbType.NVarChar,50),
					                new SqlParameter("@upd_user", SqlDbType.NVarChar,50),
					                ...
					                new SqlParameter("@order_weight", SqlDbType.Decimal,50)              
                                                         };
