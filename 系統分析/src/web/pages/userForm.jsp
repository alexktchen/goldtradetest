...
<ul>
    ...
    <li>
        <FoxconnCIC:label styleClass="desc" key="user.username"/>
    ...
    <li>
        <div>
            <div class="left">
                <FoxconnCIC:label styleClass="desc" key="user.password"/>
            ...
            <div>
                <FoxconnCIC:label styleClass="desc" key="user.confirmPassword"/>
    ...
    <li>
        <div>
            <div class="left">
                <FoxconnCIC:label styleClass="desc" key="user.email"/>
                <form:errors path="email" cssClass="fieldError"/>
                <form:input path="email" id="email" cssClass="text medium"/>
            </div>
            <div>
                <FoxconnCIC:label styleClass="desc" key="user.phoneNumber"/>
    ...
    <li>
        <FoxconnCIC:label styleClass="desc" key="user.website"/>
    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                ...
                <p><FoxconnCIC:label key="user.address.province"/></p>
            </div>
            <div class="left">
                ...
                <p><FoxconnCIC:label key="user.address.postalCode"/></p>
            </div>
            <div>
                <FoxconnCIC:country name="address.country" prompt="" default="${user.address.country}"/>
                <p><FoxconnCIC:label key="user.address.country"/></p>
            </div>
        </div>
    </li>
<c:choose>
    ...
    <li>
        <fieldset class="pickList">
            ...
            <table class="pickList">
                <tr>
                    <th class="pickLabel">
                        <FoxconnCIC:label key="user.availableRoles" colon="false" styleClass="required"/>
                    </th>
                    <td></td>
                    <th class="pickLabel">
                        <FoxconnCIC:label key="user.roles" colon="false" styleClass="required"/>
                    </th>
                </tr>
    ...
    <li>
        <strong><FoxconnCIC:label key="user.roles"/></strong>
