namespace GoldTradeNaming.Web.product_type
{
    ...
    public class Modify_index : Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.Cells[0].Text == showData.Rows[rowindex - 1].Cells[0].Text)
            {
                //是否为此轮第一次开始合并，因为span=1没有意义，必定从2开始
                if (showData.Rows[irow].Cells[1].RowSpan == 0)
                {
                    showData.Rows[irow].Cells[1].RowSpan++;
                    showData.Rows[irow].Cells[0].RowSpan++;
                }
