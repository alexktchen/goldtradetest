<%@ Page Language="C#" MasterPageFile="~/Franchiser.Master" AutoEventWireup="true" CodeBehind="myReceive.aspx.cs" Inherits="GoldTradeNaming.Web.send_main.myReceive" Title="查询收货" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>                    
                       ...
                       <asp:HyperLinkField HeaderText="查看" DataNavigateUrlFields="send_id"
                            DataNavigateUrlFormatString="../send_desc/send_produc_show.aspx?sendid={0}" Target="_blank"  Text="查看" />
