namespace GoldTradeNaming.DAL
{
    ...
    public class stock_main
    {
        public int Add(GoldTradeNaming.Model.stock_main model)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@franchiser_code", SqlDbType.NVarChar, 50), new SqlParameter("@product_id", SqlDbType.Int, 4), new SqlParameter("@product_spec_id", SqlDbType.Decimal, 8), new SqlParameter("@stock_total", SqlDbType.Decimal, 8), new SqlParameter("@stock_left", SqlDbType.Decimal, 8), new SqlParameter("@ins_user", SqlDbType.NVarChar, 50), new SqlParameter("@ins_date", SqlDbType.SmallDateTime), new SqlParameter("@upd_user", SqlDbType.NVarChar, 50), new SqlParameter("@upd_date", SqlDbType.SmallDateTime) };
        ...
        public DataSet getSalesReport(string time_from, string time_to)
        {
            ...
            try
            {
                ...
                SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@ins_date_begin", SqlDbType.NVarChar, 50), new SqlParameter("@ins_date_end", SqlDbType.NVarChar, 50) };
        ...
        public string getSumTrade()
        {
            ...
            try
            {
                ...
                CS10000 = ds.Tables[0].Rows[0][0].ToString().Trim();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public bool stock_chang(string fran_id, int product_type_id, decimal product_kind_id, int tag, int mount)
        {
            ...
            try
            {
                ...
                SqlParameter[] parameters1 = new SqlParameter[] { new SqlParameter("@franchiser_code", SqlDbType.NVarChar, 50), new SqlParameter("@product_id", SqlDbType.Int, 4), new SqlParameter("@product_spec_id", SqlDbType.Decimal, 8) };
                ...
                SqlParameter[] parameters2 = new SqlParameter[] { new SqlParameter("@franchiser_code", SqlDbType.NVarChar, 50), new SqlParameter("@product_id", SqlDbType.Int, 4), new SqlParameter("@product_spec_id", SqlDbType.Decimal, 8), new SqlParameter("@stock_total", SqlDbType.Decimal, 8), new SqlParameter("@stock_left", SqlDbType.Decimal, 8) };
                parameters2[0].Value = stock_total + mount;
                if (tag == 0)
                {
                    parameters2[1].Value = stock_left + mount;
                }
                else if (tag == 1)
                {
                    parameters2[1].Value = stock_left - mount;
                ...
                if (DbHelperSQL.ExecuteSql(strUpdate.ToString(), parameters2) > 0)
                {
                    tmp_tag = true;
                }
            }
        ...
        public void Update(GoldTradeNaming.Model.stock_main model)
        {
            ...
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 4), new SqlParameter("@franchiser_code", SqlDbType.NVarChar, 50), new SqlParameter("@product_id", SqlDbType.Int, 4), new SqlParameter("@product_spec_id", SqlDbType.Decimal, 8), new SqlParameter("@stock_total", SqlDbType.Decimal, 8), new SqlParameter("@stock_left", SqlDbType.Decimal, 8), new SqlParameter("@ins_user", SqlDbType.NVarChar, 50), new SqlParameter("@ins_date", SqlDbType.SmallDateTime), new SqlParameter("@upd_user", SqlDbType.NVarChar, 50), new SqlParameter("@upd_date", SqlDbType.SmallDateTime) };
        ...
        public int updateStock(GoldTradeNaming.Model.stock_main model)
        {
            ...
            try
            {
                SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 4), new SqlParameter("@stock_total", SqlDbType.Decimal, 8), new SqlParameter("@stock_left", SqlDbType.Decimal, 8), new SqlParameter("@upd_user", SqlDbType.NVarChar, 50) };
                parameters[0].Value = model.id;
            ...
            using (SqlConnection conn = new SqlConnection(PubConstant.ConnectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        strSql.Append(" values(");
                        strSql.Append("@franchiser_code,@product_id,@product_spec_id,@stock_total_changed,@stock_left_changed,@ins_user)");
                        SqlParameter[] parameter2 = new SqlParameter[] { new SqlParameter("@franchiser_code", SqlDbType.SmallInt, 2), new SqlParameter("@product_id", SqlDbType.Int, 4), new SqlParameter("@product_spec_id", SqlDbType.Decimal, 8), new SqlParameter("@stock_total_changed", SqlDbType.Decimal, 8), new SqlParameter("@stock_left_changed", SqlDbType.Decimal, 8), new SqlParameter("@ins_user", SqlDbType.NVarChar, 50) };
